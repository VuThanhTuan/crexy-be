...
export class Migration1762353061508 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_variants" ADD "price" numeric(18,0) DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE "product_variants" ALTER COLUMN "price" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "product_variants" ALTER COLUMN "price" SET DEFAULT '0'`);
